requirejs.config({
    ...
    paths: {
      ...
      packages: [
         ...
         {
            name: 'skylark-domx-colors',
            location : "../node_modules/skylark-domx-colors/dist/uncompressed/skylark-domx-colors",
            main: 'main'
          },   
          {
            name: 'skylark-datgui',
...
require(["skylark-domx-query"], function ($) {
    require(["skylark-datgui"], function (datgui) {
        if (window.initPage) {
            window.initPage($,datgui);
        }
    });
});